                                                ...
                                                <div class="modal" id="modaldel<?= $key->idtopik ?>">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content modal-content-demo">
                                                            ...
                                                            <form action="<?php base_url() ?>/del_bidang_minat" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="modal" id="modalupdate<?= $key->idtopik ?>">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content modal-content-demo">
                                                            ...
                                                            <form action="<?php base_url() ?>/upd_bidang_minat" method="POST" enctype="multipart/form-data">
                                                                <input type="hidden" name="idtopik" value="<?= $key->idtopik ?>" />
                                                                <div class="modal-body">
                                                                    <div class="form-group">
