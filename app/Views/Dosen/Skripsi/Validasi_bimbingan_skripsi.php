            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <p class="tx-12 tx-gray-500 mb-2">Validasi bimbingan skripsi mahasiswa </a></p>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content modal-content-demo">
                                        <div class="modal-header">
                                            <h6 class="modal-title">Validasi Bimbingan Skripsi Mahasiswa</h6><button aria-label="Close" class="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                        </div>
