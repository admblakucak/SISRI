                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">Validasi Revisi Pasca Sidang Skripsi</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                        </div>
                        <p class="tx-12 tx-gray-500 mb-2">Validasi revisi laporan skripsi pasca sidang skripsi </a></p>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content modal-content-demo">
                                        <div class="modal-header">
                                            <h6 class="modal-title">Validasi Revisi Laporan Skripsi Pasca Sidang Skripsi</h6><button aria-label="Close" class="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                        </div>
