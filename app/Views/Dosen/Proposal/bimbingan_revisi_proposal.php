    ...
    <div class="modal" id="modaladd">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="<?php base_url() ?>/tambah_bimbingan_revisi_proposal_dosen" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal" id="modaldel<?= $key->id_bimbingan ?>">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content modal-content-demo">
                                            ...
                                            <form action="<?php base_url() ?>/hapus_bimbingan_revisi_proposal_dosen" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_bimbingan" value="<?php echo $key->id_bimbingan; ?>" />
                                                <input type="hidden" name="nim" value="<?= $nim ?>">
                                                <div class="modal-body">
