                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="/setujui_validasi_usulan/<?= $id_pengajuan ?>" class="btn btn-success btn-sm"><i class="las la-check"></i></a>
                                                                                    <a href="#" data-bs-target="#modaltolak<?= $no ?>" data-bs-toggle="modal" href="" class="btn btn-sm btn-dark"><i class="las la-times"></i></a>
                                                                                    <?php if ($key->berkas == '') {
                                                                                        echo " ";
                                                                                    } else { ?>
                                                                                        <a href="/download_proposal/menunggu/<?= $id_pengajuan ?>" class="btn btn-primary btn-sm"><i class="las la-download"> Proposal</i></a>
                                                                                    <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                            <div class="modal" id="modaltolak<?= $no ?>">
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content modal-content-demo">
                                                                                        <form action="<?php base_url() ?>/tolak_validasi_usulan" method="POST" enctype="multipart/form-data">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($key->berkas == '') {
                                                                                        ...
                                                                                        <a href="/download_proposal/terima_pengajuan/<?= $key->id_pengajuan_pembimbing ?>" class="btn btn-primary btn-sm"><i class="las la-download"> Proposal</i></a>
                                                                                    <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                        <?php $no++;
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($key->berkas == '') {
                                                                                        ...
                                                                                        <a href="/download_proposal/tolak_pengajuan/<?= $key->id_penolakan_pengajuan_pembimbing ?>" class="btn btn-primary btn-sm"><i class="las la-download"> Proposal</i></a>
                                                                                    <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                        <?php $no++;
