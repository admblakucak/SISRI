...
<head>
	...
	<link href="<?php base_url() ?>/assets/plugins/datatable/datatables.min.css" rel="stylesheet" />
	<link href="<?php base_url() ?>/assets/plugins/datatable/responsive.dataTables.min.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/datatable/responsive.bootstrap5.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/datatable/css/buttons.bootstrap5.min.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/datatable/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/select2/css/select2.min.css" rel="stylesheet">
	<!--  Right-sidemenu css -->
	...
	<link href="<?php base_url() ?>/assets/plugins/multislider/multislider.css" rel="stylesheet">
	<!-- Sidemenu css -->
	...
	<link href="<?php base_url() ?>/assets/plugins/amazeui-datetimepicker/css/amazeui.datetimepicker.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/jquery-simple-datetimepicker/jquery.simple-dtpicker.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/pickerjs/picker.min.css" rel="stylesheet">
	<!-- Internal Spectrum-colorpicker css -->
	<link href="<?php base_url() ?>/assets/plugins/spectrum-colorpicker/spectrum.css" rel="stylesheet">
	<!--- Internal Select2 css-->
	<link href="<?php base_url() ?>/assets/plugins/select2/css/select2.min.css" rel="stylesheet">
	<!--Internal  Quill css -->
	<link href="<?php base_url() ?>/assets/plugins/quill/quill.snow.css" rel="stylesheet">
	<link href="<?php base_url() ?>/assets/plugins/quill/quill.bubble.css" rel="stylesheet">

	<!--  Owl-carousel css-->
	<link href="<?php base_url() ?>/assets/plugins/owl-carousel/owl.carousel.css" rel="stylesheet" />

	<!-- Maps css -->
	<link href="<?php base_url() ?>/assets/plugins/jqvmap/jqvmap.min.css" rel="stylesheet">
