                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="collapse <?= session()->getFlashdata('message') != NULL ? 'show' : ''  ?> multi-collapse" id="multiCollapseExample1">
                                <form action="<?php base_url() ?>/update_pass" method="POST" enctype="multipart/form-data">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-12"><button class="btn btn-success pd-x-20 mg-t-10" type="submit">Update Password</button>
                                            <a aria-controls="multiCollapseExample1 multiCollapseExample2" aria-expanded="false" class="btn ripple btn-light pd-x-20 mg-t-10" href=".multi-collapse" data-bs-toggle="collapse" role="button" class="col-md-10 col-lg-9 col-xl-2 offset-xl-10 pt-4">Tutup</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
