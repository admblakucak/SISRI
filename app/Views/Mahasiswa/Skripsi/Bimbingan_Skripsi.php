    ...
    <div class="modal" id="modaladd">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="<?php base_url() ?>/tambah_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="main-content-left main-content-left-chat">
                    <div class="main-chat-list" id="ChatList">
                        ...
                        ?>
                            <a href="/bimbingan_skripsi/<?= $key2->nip ?>">
                                <?php if ($notif != NULL) { ?>
                                    <div class="media new">
                                    <?php } else {
                                    ?>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="main-msg-wrapper left">
                                                ...
                                                <?php if ($key->berkas != NULL) { ?>
                                                    <hr>
                                                    <form action="<?php base_url() ?>/download_berkas_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
                                                        <input type="hidden" name="id_bimbingan" value="<?php echo $key->id_bimbingan; ?>" />
                                ...
                                <div class="modal" id="modaldel<?= $key->id_bimbingan ?>">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content modal-content-demo">
                                            ...
                                            <form action="<?php base_url() ?>/hapus_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_bimbingan" value="<?php echo $key->id_bimbingan; ?>" />
