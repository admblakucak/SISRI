                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">Daftar Sidang Skripsi</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                        </div>
                        <p class="tx-12 tx-gray-500 mb-2">Silahkan Mengisi Form Pendaftaran Sidang Skripsi</a></p>
                    </div>
                    <div class="row mt-3">
                        <div class="col">
                                    ...
                                    <div class="card-body pt-0">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <input type="teks" class="form-control" id="exampleInput" placeholder="Isikan Email Anda">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <p class="mg-b-10">File Laporan Skripsi dan Dokumen Pendaftaran Sidang Skripsi</p>
                                        ...
                                        <br>
                                        <p class="mg-b-10">File Laporan Skripsi Acc Dosen Pembimbing</p>
                                        <div class="row row-sm">
                                            <div class="col-sm-7 col-md-6 col-lg-4">
                                                <div class="input-group file-browser">
                                                    <input type="text" class="form-control border-right-0 browse-file" placeholder="Pilih File" readonly>
